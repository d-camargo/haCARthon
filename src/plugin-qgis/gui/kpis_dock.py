...
class KpisDockWidget(QDockWidget):
    ...
    def acao_parecer(self):
        ...
        try:
            ...
            # Mapa/legenda do parecer: apenas a camada "Fila Priorizada".
            base = self._fila if self._fila is not None else layer_parecer
            map_layers = [base] if base is not None else []
